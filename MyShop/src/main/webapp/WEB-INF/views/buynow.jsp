...
<body class="container-fluid bg-light " style="margin: 0%;padding: 0%;">
	    ...
	    <c:forEach items="${ sessionScope.totalProductList }" var="total">    
		    ...
		    <div class="infoWrap"> 
		        <div class="cartSection">
	        	  ...
	        	  <img src="/image/${total.path }" alt="" class="itemImg" />
	        	  
	        	  <input type="hidden" value="${total.productId }" name="id${total.productId }">
		        ...
		        <div class="prodTotal cartSection">
		          <p> <i class="fa fa-rupee" style="font-size:24px"> ${total.price }</i>  </p>
		        </div>
		              <div class="cartSection removeWrap">
		           <a href="/removeCart?id=${total.productId }" class="remove"> <i class="material-icons md-48">delete</i> </a>
		        </div>
		      </div>
	      </c:forEach>
  ...
  <div class="promoCode"><label for="promo">Have A Promo Code?</label><input type="text" placholder="Enter Code" />
    ...
    <ul>
        <li class="totalRow">
        	<span class="label">Subtotal </span>
	        	...
	        	<span class="value">
	      			<i class="fa fa-rupee" style="font-size:24px">   <%=totalPrice %> </i>
	      		</span>
      	</li>
      
          <li class="totalRow"><span class="label">Shipping</span><span class="value">
          	<i class="fa fa-rupee" style="font-size:24px">   0.0</i>
          </span></li>
            ...
            <span class="value">
            	<i class="fa fa-rupee" style="font-size:24px">   <%=tax %>  </i>
            	</span>
            </li>
            ...
            <br>
      <li class="totalRow"><button type="submit" class="btn btn-success btn-lg">Purchase</button></li>
    </ul>
