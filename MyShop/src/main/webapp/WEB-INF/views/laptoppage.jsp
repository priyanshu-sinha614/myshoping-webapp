...
<body class="bg-light">
	...
	<div class="marque"> <marquee behavior=scroll direction="left" scrollamount="17"><h2>LAPTOP BUMPER DHAMAKA OFFER ONLY <i class="fa fa-rupee" style="font-size:24px"></i> 30000 to <i class="fa fa-rupee" style="font-size:24px"></i> 80000 </h2></marquee> </div>
    

	<div class="container mt-4">
	  <div class="row row-cols-4">
	  
	  	<c:forEach items="${laptops }" var="arr">
